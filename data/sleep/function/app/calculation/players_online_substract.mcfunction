...
execute if score &afk_players_sleep sleep.config matches 1 store result score &playerNumAFK sleep.players if entity @a[tag=afkannouncer.afk]
...
execute if score &dimension_sleep sleep.config matches 1 store result score &playerNumNether sleep.players if entity @a[tag=!afkannouncer.afk,nbt={Dimension:"minecraft:the_nether"}]

execute if score &dimension_sleep sleep.config matches 1 store result score &playerNumEnd sleep.players if entity @a[tag=!afkannouncer.afk,nbt={Dimension:"minecraft:the_end"}]
