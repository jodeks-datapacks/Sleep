...
# set base value
scoreboard players set &temp_night_end sleep.time_values 24000
...
execute if score &daytime sleep.time_values matches 12542..24000 run scoreboard players operation &skip_time sleep.time_values = &temp_night_end sleep.time_values
execute if score &daytime sleep.time_values matches 12542..24000 run scoreboard players operation &skip_time sleep.time_values -= &daytime sleep.time_values
...
execute store result storage sleep:root data.skip_time int 1 run scoreboard players get &skip_time sleep.time_values