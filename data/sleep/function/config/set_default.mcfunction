execute unless score &time_until_skip sleep.config = &time_until_skip sleep.config run data modify storage sleep:root data.time_until_skip set value 5
...
execute unless score &amount_to_sleep sleep.config = &amount_to_sleep sleep.config run data modify storage sleep:root data.amount_to_sleep set value 1
...
execute unless score &percentage_mode sleep.config = &percentage_mode sleep.config run data modify storage sleep:root data.amount_mode_initial set value 1
execute unless score &percentage_mode sleep.config = &percentage_mode sleep.config run data modify storage sleep:root data.percentage_mode_initial set value 0
...
execute unless score &percentage_to_sleep sleep.config = &percentage_to_sleep sleep.config run data modify storage sleep:root data.percentage_to_sleep set value 50
...
execute unless score &time_control sleep.config = &time_control sleep.config run data modify storage sleep:root data.time_skip_initial set value 1
execute unless score &time_control sleep.config = &time_control sleep.config run data modify storage sleep:root data.time_warp_initial set value 0
...
execute unless score &afk_players_sleep sleep.config = &afk_players_sleep sleep.config run data modify storage sleep:root data.afk_players_sleep set value 0
...
execute unless score &heal_instant sleep.config = &heal_instant sleep.config run data modify storage sleep:root data.heal_instant set value 0
...
execute unless score &heal_regeneration sleep.config = &heal_regeneration sleep.config run data modify storage sleep:root data.heal_regeneration set value 0
...
execute unless score &dimension_sleep sleep.config = &dimension_sleep sleep.config run data modify storage sleep:root data.dimension_sleep set value 0
...
execute unless score &tick_accelerate sleep.config = &tick_accelerate sleep.config run data modify storage sleep:root data.tick_accelerate set value 0
...
execute unless score &actionbar_display_name sleep.config = &actionbar_display_name sleep.config run data modify storage sleep:root data.actionbar_display_name_initial set value 1
...
execute unless score &actionbar_display_selector sleep.config = &actionbar_display_selector sleep.config run data modify storage sleep:root data.actionbar_display_selector_initial set value 0
...
execute unless score &notification_chat sleep.config = &notification_chat sleep.config run data modify storage sleep:root data.notification_chat set value 0
...
execute unless score &notification_sound sleep.config = &notification_sound sleep.config run data modify storage sleep:root data.notification_sound set value 0
