...
execute as @a[scores={sleep_notification=2}] at @s if score Timeofday sleep.clock matches 12542 run playsound minecraft:block.note_block.cow_bell voice @s
...
execute as @a[scores={sleep_notification=3}] at @s if score Timeofday sleep.clock matches 12542 run playsound minecraft:block.note_block.cow_bell voice @s
